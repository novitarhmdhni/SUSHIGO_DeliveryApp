...
public class InfoActivity extends AppCompatActivity implements LoaderManager.LoaderCallbacks<Cursor> {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        drinnkName.setText("Spicy Ikura Roll");
        ...
        plusquantity.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                coffeePrice.setText("Rp." + ifCheckBox);
    ...
    private boolean SaveCart() {
        ...
        if (addExtraCream.isChecked()) {
            values.put(OrderContract.OrderEntry.COLUMN_CREAM, "Has Toppings: YES");
        } else {
            values.put(OrderContract.OrderEntry.COLUMN_CREAM, "Has Toppings: NO");

        }

        if (addToppings.isChecked()) {
            values.put(OrderContract.OrderEntry.COLUMN_HASTOPPING, "Has Extra Add: YES");
        } else {
            values.put(OrderContract.OrderEntry.COLUMN_HASTOPPING, "Has Extra Add: NO");
